...
class ClientCabinetProfile(models.Model):
    """Профиль клиента в личном кабинете"""
    
    user = models.OneToOneField(User, on_delete=models.CASCADE, verbose_name='Пользователь')
    client = models.ForeignKey(Client, on_delete=models.CASCADE, verbose_name='Клиент CRM', null=True, blank=True)
    ...
    def __str__(self):
        return f'Кабинет: {self.user.username}'
